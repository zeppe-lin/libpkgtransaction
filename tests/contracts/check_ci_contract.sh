...
for pin in 9a2a85c85c20bbfa77306f3eb14ccc67ac1e800c 16976cac176f576871e327d5d2f6fe9d9dfa0666 f74df278b47b48e798c3de01c922c59b58319d13 9e030b49606d5ac78bb1ee0c868681a37d0726cc; do grep -F "$pin" "$workflow" >/dev/null || fail "CI omits authority pin/tree $pin"; done
