...
for expected in libpkgsource.so.4 libpkgcatalog.so.4 libpkgresolve.so.4 libpkgstate.so.4; do
...
for obsolete in \
  ...
  libpkgcatalog.so.1 libpkgcatalog.so.2 libpkgcatalog.so.3 \
  libpkgresolve.so.1 libpkgresolve.so.2 libpkgresolve.so.3 \
